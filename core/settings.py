...
SECRET_KEY = os.environ.get(
    'DJANGO_SECRET_KEY',
    'django-insecure-p3-y+u@_)!dcv4fb9i*i1#(oh3x9nm7embj3)k2=96rz7e0pzz',
)
...
MIDDLEWARE = [
    ...
    'board.middleware.LastSeenMiddleware',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'board.context_processors.presence',
                'board.context_processors.unread_messages',
            ],
        },
    },
]
